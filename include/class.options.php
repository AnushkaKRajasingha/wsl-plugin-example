                    ...
                    if(is_multisite())
                        {
                            if(isset($screen->id) && $screen->id    ==  'settings_page_woo-ms-options-network')
                                return;
                            ?><div class="updated fade"><p><?php _e( "WooCommerce Software Licence - Plugin Example is inactive, please enter your", 'wooslt' ) ?> <a href="<?php echo network_admin_url() ?>settings.php?page=woo-ms-options"><?php _e( "Licence Key", 'wooslt' ) ?></a></p></div><?php
                        }
                        else
                        {
                            ...
                            ?><div class="updated fade"><p><?php _e( "WooCommerce Software Licence - Plugin Example is inactive, please enter your", 'wooslt' ) ?> <a href="options-general.php?page=woo-options"><?php _e( "Licence Key", 'wooslt' ) ?></a></p></div><?php
                        }
                }
